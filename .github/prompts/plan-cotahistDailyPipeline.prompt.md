...
4. ✓ Updated [templates/b3-cotahist-daily.yaml](templates/b3-cotahist-daily.yaml):
   ...
   - Filters to keep only `tipo_registro == "01"` rows
...
- ✓ Cleaned up temporary `b3-cotahist-daily-pipeline.yaml` file
...
- Modified: `templates/b3-cotahist-daily.yaml` (complete migration)
