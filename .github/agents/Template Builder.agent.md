---
description: "Expert agent to convert brasa's legacy function-based ETL templates to pipeline-based declarative ETL templates with testing."
name: "Brasa Template Builder"
---
# Convert legcy function-based ETL templates to Pipeline-Based ETL
...
- Replace with `pipeline` section containing three steps:
  1. `load` - references `b3-bvbg028-equities` dataset
  2. `select` - specifies all 31 columns to keep
  3. `drop_duplicates` - removes duplicate rows, keeping first occurrence
