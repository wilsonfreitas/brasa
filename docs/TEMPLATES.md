...
| **ETL (Single)** | Transform dataset → derived dataset | `etl:`, `writer:`, `fields:` | Single parquet dataset | `b3-curves-dap` |
...
**Template:** `b3-curves-dap` (simplified)
